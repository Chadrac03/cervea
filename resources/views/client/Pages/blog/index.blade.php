...
@section('content')
    ...
    <div class="owl-carousel-wrapper">
        <div class="owl-carousel dots-inside dots-horizontal-center show-dots-hover dots-light nav-style-1 nav-inside nav-inside-plus nav-dark nav-lg nav-font-size-lg show-nav-hover mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 1}, '979': {'items': 1}, '1199': {'items': 1}}, 'loop': false, 'autoHeight': false, 'margin': 0, 'dots': true, 'dotsVerticalOffset': '-35px', 'nav': false, 'animateIn': 'fadeIn', 'animateOut': 'fadeOut', 'mouseDrag': false, 'touchDrag': false, 'pullDrag': false, 'autoplay': true, 'autoplayTimeout': 9000, 'autoplayHoverPause': true, 'rewind': true}">
            <!-- Carousel Slide 2 -->
            <div class="position-relative overlay overlay-show overlay-op-7" data-dynamic-height="['650px','650px','650px','550px','500px']" style="background-image: url({{ url('asset/img/slides/slide-corporate-2-1.jpg') }}); background-size: cover; background-position: center; height: 400px;">
                    ...
                    <div class="row justify-content-center align-items-center h-100">
                        <div class="col-lg-7 text-center mt-2">
                            <div class="d-flex flex-column align-items-center justify-content-center pt-4">
                                ...
                                <h3 class="text-color-light font-weight-extra-bold text-12-13 line-height-1 line-height-sm-3 mb-2 appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}"> TOUS NOS CONSEILS SUR NOTRE BLOG</h3>
                                <p class="text-3 text-color-light font-weight-light opacity-7 text-center" data-plugin-animated-letters data-plugin-options="{'startDelay': 1000, 'minWindowWidth': 0, 'animationSpeed': 30}">SPÉCIALISÉ APPLICATION WEB ET MOBILE</p>
        ...
        <div class="container">
            <div class="row mb-5 counters">
                <div class="col-lg-10 text-center offset-lg-1">
                    <h2 class="font-weight-bold text-9 mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-duration="750" data-plugin-options="{'accY': -200}"></h2>
                    ...
                    <p class="text-1rem text-color-default negative-ls-05 pt-3 pb-4 mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750">
                        En tant que spécialistes en développement d’applications métiers web et mobiles, nous souhaitons partager notre expérience.
                        Vous trouverez dans notre blog différents articles qui vous permettront de développer votre application plus sereinement.
                        Guide, conseils, outils, bonnes pratiques de développement, vous trouverez toutes les informations dont vous avez besoin de l’idée à la livraison de votre projet.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @include('client.Sections.blog-article')
    ...
    <section id="intro" class="section section-no-border section-angled bg-light pt-5 m-0 mt-4">
        ...
        <div class="container">
            <div class="row counters">
                <div class="col-lg-10 text-center offset-lg-1">
                    <h2 class="font-weight-bold text-9 mb-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-duration="750" data-plugin-options="{'accY': -200}">NOS ARTICLES PAR THÈME</h2>
                    <p class="sub-title text-primary text-4 font-weight-semibold positive-ls-2 mt-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750"><span class="highlighted-word highlighted-word-animation-1 highlighted-word-animation-1-2 highlighted-word-animation-1 highlighted-word-animation-1-no-rotate alternative-font-4 font-weight-semibold line-height-2 pb-2">cervea</span></p>
                    <p class="text-1rem text-color-default negative-ls-05 pt-3 pb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750">
                        Notre blog compte maintenant près de 100 articles dédiés au développement d’applications et logiciels professionnels
                        ainsi qu’à la gestion de projet numérique.</p>
                </div>
            </div>
        </div>
    </section>

    @include('client.Sections.blog-cahier')

    @include('client.Sections.blog-dev-articles')

    @include('client.Sections.blog-all-artilces')
